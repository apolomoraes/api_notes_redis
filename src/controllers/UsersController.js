...
const { getRedis } = require('../../redisConfig')
...
class UsersController {
  ...
  */
  ...
  async index(request, response) {
    ...
    const userTransform = JSON.parse(userRedis);

    // const user = await database.get('SELECT id, name, email FROM users WHERE id = (?)', [user_id])
